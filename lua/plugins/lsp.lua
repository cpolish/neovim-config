return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by blink.nvim
      "saghen/blink.cmp",
    },
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>sd', fzf_lua.lsp_document_symbols, '[D]ocument [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>sw', fzf_lua.lsp_workspace_symbols, '[W]orkspace [S]ymbols')
      ...
      -- So, we create new capabilities with nvim cmp, and then broadcast that to the
      -- servers.
